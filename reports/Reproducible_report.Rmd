---
title: "Figures: Using dN/dS to measure selection strength in cancer"
output:
  github_document:
    html_preview: false
    fig_width: 7
...
```{r fig-pnps, fig.height=11, fig.width=15}
...
```{r fig-2, fig.height=12, fig.width=12}
...
```{r fig-3, fig.height=6, fig.width=10}
...
```{r fig-4, fig.height=12, fig.width=12}
...
```{r fig-5, fig.height=5, fig.width=12}
