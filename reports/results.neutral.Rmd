...
We arbitrarily created a genome of 10000 synonymous sites (S). The number of non-sybobynous sites (N) used is 27600, to fit the estimation of $N/S = 2.76$ obtained in human soman based on codon usage and mutational spectrum (Milhollland et al. 2017). This yield a total number of 37600 sites. In this scenario all the N sites are neutral. The mutation rate is set in $2.66\times10^{-9}$ as representative of human somatic mutation (Milholland et al. 2017). A starting population of 10000 cells, all with the same genotype, is evolved for 50000 time units, taking samples avery 500 time units. This simulation setting is replicated 1000 times.
