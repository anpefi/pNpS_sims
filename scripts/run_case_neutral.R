...
fe <- allFitnessEffects(noIntGenes = loci, drvNames = names(loci[1:nNS_pos]) )
...
mc.cores <- 1 #cores to use
det.limit <- 0.05  #Threshold for a variant frequency to be detected
