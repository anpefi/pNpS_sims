...
#SBATCH -J pos_0.25_neg_0.75           # Job name
#SBATCH -o out/pos_0.25_neg_0.75_%j    # Specify stdout output file (%j expands to jobId)
...
$SCRIPT_DIR/run_simulation3.R -i ${SLURM_JOB_NAME}_${SLURM_JOB_ID} --model Exp --sampleEvery 0.01 \
  --s_pos 0.25 --s_neg -0.75 \
  -r 1000  -t 10000000 --keepEvery 10000000 \
  --n_pos 1 --n_neu 1 --n_neg 1.75 \
