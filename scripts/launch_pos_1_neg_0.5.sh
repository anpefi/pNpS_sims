...
#SBATCH -J pos_1_neg_0.5           # Job name
#SBATCH -o out/pos_1_neg_0.5_%j    # Specify stdout output file (%j expands to jobId)
...
$SCRIPT_DIR/run_simulation3.R -i ${SLURM_JOB_NAME}_${SLURM_JOB_ID} --model Exp --sampleEvery 0.01 \
  --s_pos 1 --s_neg -0.5 \
  -r 942  -t 10000000 --keepEvery 10000000 \
  --n_pos 1 --n_neu 1 --n_neg 1.5 \
