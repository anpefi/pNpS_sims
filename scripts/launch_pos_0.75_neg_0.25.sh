...
#SBATCH -J pos_0.75_neg_0.25           # Job name
#SBATCH -o out/pos_0.75_neg_0.25_%j    # Specify stdout output file (%j expands to jobId)
...
$SCRIPT_DIR/run_simulation3.R -i ${SLURM_JOB_NAME}_${SLURM_JOB_ID} --model Exp --sampleEvery 0.01 \
  --s_pos 0.75 --s_neg -0.25 \
  -r 1000  -t 10000000 --keepEvery 10000000 \
  --n_pos 1 --n_neu 1 --n_neg 1.25 \
